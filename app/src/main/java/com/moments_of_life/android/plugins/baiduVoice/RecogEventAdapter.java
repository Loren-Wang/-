package com.moments_of_life.android.plugins.baiduVoice;

import android.util.Log;

import com.baidu.speech.EventListener;
import com.baidu.speech.asr.SpeechConstant;
import com.moments_of_life.android.plugins.baiduVoice.control.ErrorTranslation;
    ...
    public void onEvent(String name, String params, byte[] data, int offset, int length) {
        ...
        if (name.equals(SpeechConstant.CALLBACK_EVENT_ASR_LOADED)) {
            ...
            if (recogResult.hasError()) {
                ...
                LogUtils.logE(TAG, "asr error:" + params);
            ...
            if (data.length != length) {
                LogUtils.logE(TAG, "internal error: asr.audio callback data length is not equal to length param");
            }
