package com.moments_of_life.android.plugins.baiduVoice.control;
...
import com.moments_of_life.android.plugins.baiduVoice.RecogEventAdapter;
...
public class MyRecognizer {
    ...
    public MyRecognizer(Context context, EventListener eventListener) {
        if (isInited) {
            LogUtils.logE(TAG, "还未调用release()，请勿新建一个新类");
    ...
    public void loadOfflineEngine(Map<String, Object> params) {
        ...
        LogUtils.logI(TAG + ".Debug", "loadOfflineEngine params:" + json);
    ...
    public void start(Map<String, Object> params) {
        String json = new JSONObject(params).toString();
        LogUtils.logI(TAG + ".Debug", "asr params(反馈请带上此行日志):" + json);
    ...
    public MyRecognizer setStart(boolean start) {
        isStart = start;
        return this;
    }
